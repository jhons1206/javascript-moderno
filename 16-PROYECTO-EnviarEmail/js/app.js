document.addEventListener('DOMContentLoaded', function() {
    ...
    const inputCopia = document.querySelector('#copia'); // Seleccionamos el elemento "CC"
    ...
    function validar(e) {
        ...
        if(e.target.id === 'copia' && e.target.value === '') {
    ...
    function resetFormulario() {
        ...
        // Borramos "CC" en caso que el campo contenga algo
        delete (email.copia);
